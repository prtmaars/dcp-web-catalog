...
export const whatsNewData: WhatsNewItem[] = [
  {
    ...
    type: "Update",
    description: {
      id: "Penambahan Kereta Modifikasi New Generation pada Ekonomi Pack.",
      en: "New Generation Modified Train Addition to the Ekonomi Pack.",
      ko: "Ekonomi Pack에 새로운 세대 개량형 열차가 추가되었습니다.",
    },
  },
  {
    date: "2026/02/23",
  ...
  },
  {
    ...
    type: "New Content",
    description: {
      id: "Rilis publik gerbong ketel (KKW) 30 ton (versi beta).",
      en: "Public release of 30 ton tanker (KKW) (beta version).",
      ko: "30톤 탱커(KKW) 공개(베타 버전).",
    },
  },
  {
    date: "2025/11/09",
