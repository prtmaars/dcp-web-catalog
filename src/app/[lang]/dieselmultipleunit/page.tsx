...
import { dieselMultipleUnit } from "./dieselmultipleunit";
...
export default function dieselMultipleUnitPage() {
  ...
  const [selected, setSelected] = useState<typeof dieselMultipleUnit[0] | null>(null);
  const [page, setPage] = useState(0);

  const imagesPerPage = 1;

  const handleDetail = (item: typeof dieselMultipleUnit[0]) => {
    setSelected(item);
    setPage(0);
    setOpen(true);
  };

  const handleBuy = (item: typeof dieselMultipleUnit[0]) => {
